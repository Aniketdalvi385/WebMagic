...
def extract_text_content(soup):
    ...
    content_elements = soup.find_all(['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'table','ul', 'ol'])
...
def main():
    ...
    user_question = st.text_input("Ask a question about your website now : ", placeholder="Process the website first!")
    if user_question:
